...
import com.upray.customer.model.CustomerModel;
...
public class CustomerModelImpl
	...
	public static final String TABLE_SQL_CREATE =
		"create table Customer_Customer (uuid_ VARCHAR(75) null,customerId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null)";
	...
	public static final String ORDER_BY_SQL =
		" ORDER BY Customer_Customer.name ASC";
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"customerId",
				(BiConsumer<Customer, Long>)Customer::setCustomerId);
			attributeSetterBiConsumers.put(
				"companyId",
				(BiConsumer<Customer, Long>)Customer::setCompanyId);
			attributeSetterBiConsumers.put(
				"userId", (BiConsumer<Customer, Long>)Customer::setUserId);
			attributeSetterBiConsumers.put(
				"userName",
				(BiConsumer<Customer, String>)Customer::setUserName);
			attributeSetterBiConsumers.put(
				"createDate",
				(BiConsumer<Customer, Date>)Customer::setCreateDate);
			attributeSetterBiConsumers.put(
				"modifiedDate",
	...
	public <T> T getColumnValue(String columnName) {
		...
		Function<Customer, Object> function =
