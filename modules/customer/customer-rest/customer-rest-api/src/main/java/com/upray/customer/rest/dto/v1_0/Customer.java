package com.upray.customer.rest.dto.v1_0;
...
public class Customer implements Serializable {
	...
	public static Customer toDTO(String json) {
		return ObjectMapperUtil.readValue(Customer.class, json);
	}

	public static Customer unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Customer.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.upray.customer.rest.dto.v1_0.Customer",
		name = "x-class-name"
	)
