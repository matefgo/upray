 ...
 * <code>com.upray.project.service.impl.ProjectLocalServiceImpl</code> and
...
public class ProjectLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.upray.project.service.impl.ProjectLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Project fetchProjectByUuidAndCompanyId(
	 ...
	 */
	public static Project getProjectByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException {
	...
	public static long getProjectsCount(String search) {
		return getService().getProjectsCount(search);
	}
	...
	private static final Snapshot<ProjectLocalService> _serviceSnapshot =
		new Snapshot<>(
			ProjectLocalServiceUtil.class, ProjectLocalService.class);
